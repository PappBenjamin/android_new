...
class SplashActivity : AppCompatActivity() {
    ...
    private fun startAnimations() {
        val logo = findViewById<android.widget.ImageView>(R.id.imageViewLogo)
        val appName = findViewById<android.widget.TextView>(R.id.textViewAppName)
        val description = findViewById<android.widget.TextView>(R.id.textViewDescription)
        
        val animation = android.view.animation.AnimationUtils.loadAnimation(this, R.anim.splash_fade_in)
    ...
    private fun navigateToLogin() {
        val intent = Intent(this@SplashActivity, com.firstapp.myapplication.auth.LoginActivity::class.java)
        startActivity(intent)
        finish()
    }
